        ...
        <div className="flex flex-col w-full gap-4 lg:w-1/2 lg:p-10">
          <div className="collapse collapse-arrow rounded-3xl">
            ...
            <div className="pt-4 bg-white collapse-content peer-checked:bg-blue-100">
              <p>You can discuss your doubts in real-time on MeTrack. So, no stopping after you encounter an error while following a tutorial. You can even post code snippets in the discussions as it is markdown supported.</p>
            </div>
          </div>
          <div className="collapse collapse-arrow rounded-3xl">
            <input type="checkbox" className="peer" />
            ...
            <div className="pt-4 bg-white collapse-content peer-checked:bg-blue-100">
              <p>View all the project submissions by others enrolled in the same course or tutorial. You can submit your own project as well.</p>
            </div>
          </div>
          <div className="collapse collapse-arrow rounded-3xl">
            <input type="checkbox" className="peer" />
            ...
            <div className="pt-4 bg-white collapse-content peer-checked:bg-blue-100">
              <p>
                Show your potential clients and recruiters that you&apos;ve learnt and built something useful. Those who view your project can add a feedback. This will help you improve your project over time. Your project can be an inspiration for others!
              </p>
            </div>
          </div>
        </div>
