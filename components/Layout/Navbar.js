            ...
            <div className='dropdown dropdown-hover dropdown-end'>
              ...
              <ul tabIndex="0" className="dropdown-content menu p-6 shadow-lg bg-white rounded-box w-96 ">
                ...
                <li className='text-sm'>
                  <Link href="/account">
                    <a className='hover:bg-red-50 active:bg-red-300'><MdOutlineDashboard className='font-bold text-base' />Dashboard </a>
                  </Link>
                </li>
                <li className='text-sm'>
                  <a className='hover:bg-red-50 active:bg-red-300'><TbLogout className='font-bold text-base' />Logout</a>
                </li>
              </ul>
            </div>
