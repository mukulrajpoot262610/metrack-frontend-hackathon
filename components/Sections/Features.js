...
const Features = () => {
    return (
        <div className='relative mt-20 gap-4 w-full min-h-screen flex justify-center items-center flex-col'>
            <h1 className='text-3xl lg:text-5xl font-bold text-center'>The Only “Platform” You Need To Learn</h1>
            <p className='font-medium text-lg text-center'>Here are the possible scenarios to get the most out of this platform</p>
