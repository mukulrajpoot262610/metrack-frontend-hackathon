...
const Features = () => {
    return (
        <div className='relative mt-20 gap-4 w-full min-h-screen flex justify-center items-center flex-col'>
            <h1 className='text-5xl font-bold'>The Only “Platform” You Need To Learn</h1>
            <p className='font-medium text-lg'>Here are the possible scenarios to get the most out of this platform</p>

            <div className='flex items-center justify-center w-full mt-10'>
                <div className='w-full lg:w-1/2 flex flex-col gap-4 p-10'>
                ...
                <div className='w-full lg:w-1/2 p-10 flex justify-center items-center'>
                    <img src='https://fueler.io/images/fueler/main/fueler-internship-externship.webp' className='w-full' />
                </div>
            </div>
